...
public class TrelloFacadeTest {
    ...
    public void shouldCreateNewCard() {
        //Given
        TrelloCard trelloCard = new TrelloCard("Test task", "Test description", "top", "id1");
        TrelloCardDto trelloCardDto = new TrelloCardDto("Test task","Test description","top","id1");
